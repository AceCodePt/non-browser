...
// 1. Row heights with different cell content + specified height
...
// 2. Table with specified width, columns content-sized
...
// 5. border-collapse collapse geometry
...
// 6. anonymous boxes: stray text + block div in table
...
// 7. vertical-align middle vs top
await probe('valign',
...
// 9. min/max content width distribution with colspan (shrink)
