 ...
 * masked (mask.png). The text *geometry* (line boxes, paragraph rects, float
 * intrusion) is verified exactly by layer-3 and by the unmasked box pixels on
 * layer-4. The text mask is generated from Chrome's own line-fragment rects,
 * so it tracks the text wherever it wraps.
 *
