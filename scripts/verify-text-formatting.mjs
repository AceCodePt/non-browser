#!/usr/bin/env node
/**
 * `npm run verify:text-formatting`
 *
 * Renders every corpus/text-formatting fixture with the engine, harvests the Chrome
...
const corpus = resolve('corpus/text-formatting');
...
const report = buildReport(results, { fixtureSet: 'corpus/text-formatting', tolerancesVersion: tolerances.version });
