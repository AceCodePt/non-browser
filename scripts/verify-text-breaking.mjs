#!/usr/bin/env node
/**
 * `npm run verify:text-breaking`
 *
 * Renders every corpus/text-breaking fixture with the engine, harvests the Chrome
...
const corpus = resolve('corpus/text-breaking');
...
const report = buildReport(results, { fixtureSet: 'corpus/text-breaking', tolerancesVersion: tolerances.version });
