#!/usr/bin/env node
/**
 * `npm run verify:aspect-ratio`
 *
 * Renders every corpus/aspect-ratio fixture with the engine, harvests the Chrome
...
const corpus = resolve('corpus/aspect-ratio');
...
const report = buildReport(results, { fixtureSet: 'corpus/aspect-ratio', tolerancesVersion: tolerances.version });
