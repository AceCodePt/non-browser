 ...
 *
 * Renders every corpus/sticky fixture with the engine, harvests the Chrome
...
const corpus = resolve('corpus/sticky');
...
const report = buildReport(results, { fixtureSet: 'corpus/sticky', tolerancesVersion: tolerances.version });
