#!/usr/bin/env node
/**
 * `npm run verify:br-wbr`
 *
 * Renders every corpus/br-wbr fixture with the engine, harvests the Chrome
...
const corpus = resolve('corpus/br-wbr');
...
const report = buildReport(results, { fixtureSet: 'corpus/br-wbr', tolerancesVersion: tolerances.version });
