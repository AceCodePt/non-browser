#!/usr/bin/env node
/**
 * `npm run verify:layout-flexbox`
 *
 * Renders every corpus/flexbox fixture with the engine, harvests the Chrome
...
const report = buildReport(results, { fixtureSet: 'corpus/flexbox', tolerancesVersion: tolerances.version });
